...
} from "../openers/record-proof-opener.ts";
import {
...
export type RuntimeProofOpenRunnerInterruptionPoint =
  RuntimeCheckpointRunnerInterruptionPoint;

export type RuntimeProofOpenRunnerSuccessResult =
  RuntimeCheckpointRunnerSuccessResult;

export type RuntimeProofOpenRunnerInterruptedResult =
  RuntimeCheckpointRunnerInterruptedResult;

export type RuntimeProofOpenRunnerResult =
  | RuntimeProofOpenRunnerSuccessResult
  | RuntimeProofOpenRunnerInterruptedResult;
