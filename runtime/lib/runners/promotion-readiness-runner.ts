...
} from "../openers/promotion-readiness.ts";
import {
...
export type RuntimePromotionReadinessRunnerInterruptionPoint =
  RuntimeCheckpointRunnerInterruptionPoint;

export type RuntimePromotionReadinessRunnerSuccessResult =
  RuntimeCheckpointRunnerSuccessResult;

export type RuntimePromotionReadinessRunnerInterruptedResult =
  RuntimeCheckpointRunnerInterruptedResult;

export type RuntimePromotionReadinessRunnerResult =
  | RuntimePromotionReadinessRunnerSuccessResult
  | RuntimePromotionReadinessRunnerInterruptedResult;
