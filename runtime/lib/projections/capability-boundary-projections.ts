...
export type MirroredRuntimeCapabilityBoundaryOpenProjectionInput = {
  snapshotAt: string;
  approvedBy: string;
  boundaryDate: string;
  candidateId: string;
...
export type RuntimeCapabilityBoundaryProjectionSet =
  | {
      ok: false;
      reason:
        | "missing_case_record"
...
export function materializeDirectiveRuntimeCapabilityBoundaryProjectionSet(input: {
  ...
  caseId: string;
}): RuntimeCapabilityBoundaryProjectionSet {
