...
} from "../writers/promotion-record-writer.ts";
import { resolveDirectiveRuntimePromotionSpecificationPath } from "../host/promotion-specification.ts";

export type RuntimePromotionAssistanceState =
...
export type RuntimePromotionAssistanceActionKind =
  | "none"
...
export type RuntimePromotionAssistanceHostScope =
  | "directive_workspace_host"
  | "external_host"
  | "pending_host_selection";

export type RuntimePromotionAssistanceRecommendation = {
  candidateId: string;
  ...
  hostScope: RuntimePromotionAssistanceHostScope;
  assistanceState: RuntimePromotionAssistanceState;
  recommendedActionKind: RuntimePromotionAssistanceActionKind;
...
export type RuntimePromotionAssistanceReport = {
  ok: boolean;
  checkerId: string;
  snapshotAt: string;
  ...
  topRecommendation: RuntimePromotionAssistanceRecommendation | null;
  recommendations: RuntimePromotionAssistanceRecommendation[];
};
...
function classifyHostScope(
  proposedHost: string | null,
): RuntimePromotionAssistanceHostScope {
  ...
  if (
    normalized.startsWith("directive workspace")
...
function determineRecommendation(input: {
...
}): RuntimePromotionAssistanceRecommendation {
  ...
  let assistanceState: RuntimePromotionAssistanceState;
  let recommendedActionKind: RuntimePromotionAssistanceActionKind;
...
function recommendationPriority(
  recommendation: RuntimePromotionAssistanceRecommendation,
) {
...
function compareRecommendations(
  left: RuntimePromotionAssistanceRecommendation,
  right: RuntimePromotionAssistanceRecommendation,
) {
...
export function buildDirectiveRuntimePromotionAssistanceReport(input?: {
  ...
  snapshotAt?: string;
}): RuntimePromotionAssistanceReport {
