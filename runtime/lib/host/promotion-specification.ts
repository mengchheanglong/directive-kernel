...
export type RuntimePromotionSpecificationLinkedArtifacts = {
...
export type RuntimePromotionReadinessFields = {
  candidateId: string;
  ...
  linkedArtifacts: RuntimePromotionSpecificationLinkedArtifacts;
};

export type RuntimePromotionSpecification = {
  schemaVersion: 1;
  generatedAt: string;
  candidateId: string;
  candidateName: string;
...
export function parseDirectiveRuntimePromotionReadinessFields(input: {
  ...
  promotionReadinessPath: string;
}): RuntimePromotionReadinessFields {
...
export function readDirectiveRuntimePromotionSpecification(input: {
  ...
  return JSON.parse(fs.readFileSync(absolutePath, "utf8")) as RuntimePromotionSpecification;
}
