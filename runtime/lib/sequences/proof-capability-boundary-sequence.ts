...
import { readDirectiveRuntimeRecordArtifact } from "../openers/record-proof-opener.ts";
import {
...
export type RuntimeProofCapabilityBoundarySequenceAction =
  | "runtime_proof_open"
  | "runtime_capability_boundary_open";

export type RuntimeProofCapabilityBoundarySequenceStepInput = {
  actionKind: RuntimeProofCapabilityBoundarySequenceAction;
  targetPath: string;
  approvedBy: string;
};

export type RuntimeProofCapabilityBoundarySequenceInterruptionPoint =
  RuntimeTwoStepSequenceInterruptionPoint;

export type RuntimeProofCapabilityBoundarySequenceInput = {
  steps: [
    RuntimeProofCapabilityBoundarySequenceStepInput,
    RuntimeProofCapabilityBoundarySequenceStepInput,
  ];
  approved?: boolean;
  directiveRoot?: string;
  sequenceId?: string | null;
  testInterruptPoint?: RuntimeProofCapabilityBoundarySequenceInterruptionPoint;
};

export type RuntimeProofCapabilityBoundarySequenceSuccessResult =
  RuntimeTwoStepSequenceSuccessResult;

export type RuntimeProofCapabilityBoundarySequenceInterruptedResult =
  RuntimeTwoStepSequenceInterruptedResult;

export type RuntimeProofCapabilityBoundarySequenceResult =
  | RuntimeProofCapabilityBoundarySequenceSuccessResult
  | RuntimeProofCapabilityBoundarySequenceInterruptedResult;

const REQUIRED_SEQUENCE: [
  RuntimeProofCapabilityBoundarySequenceAction,
  RuntimeProofCapabilityBoundarySequenceAction,
] = [
  "runtime_proof_open",
  "runtime_capability_boundary_open",
