...
- when a structured review must resolve into an actual next-state recommendation, use `architecture/lib/adoption/architecture-review-resolution.ts` instead of ad hoc score or outcome logic
