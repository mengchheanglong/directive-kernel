**Enforced by:** architecture/lib/adoption/review-resolution.ts
...
- when a structured review must resolve into an actual next-state recommendation, use `architecture/lib/adoption/review-resolution.ts` instead of ad hoc score or outcome logic
