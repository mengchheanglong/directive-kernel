import type {
  ...
  DirectiveRoutingDigest,
  DirectiveRoutingDigestConcern,
  DirectiveRoutingDigestConcernKind,
} from "../types.ts";

type RoutingAssessmentForDigest = Omit<DirectiveEngineRoutingAssessment, "digest">;
type RankedConcernKind = Exclude<DirectiveRoutingDigestConcernKind, "none">;
