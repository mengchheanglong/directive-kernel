import type { DirectiveEngineMissionContext } from "../types.ts";
import { clampInt, deriveRecommendedLane } from "./routing-shared.ts";
...
type DirectiveGoalCopilotAssessment = ReturnType<typeof deriveGoalCopilotAssessment>;
...
export type {
  DirectiveGoalCopilotAssessment,
};
