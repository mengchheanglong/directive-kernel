...
import { createFilesystemEngineStore } from "../storage.ts";
import { deriveDirectiveMissionHealth, type MissionHealthAssessment } from "./health.ts";
import {
...
export type MissionFeedbackEntry = {
  ...
  suggestedMissionDelta: EngineMissionPreviewChange;
...
export function generateMissionFeedbackEntries(input: {
  mission: EngineMissionContext;
  existingRuns?: EngineRunRecord[];
  healthAssessment: MissionHealthAssessment;
  goalCopilot?: {
