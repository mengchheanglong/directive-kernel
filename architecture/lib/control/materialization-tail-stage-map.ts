...
export type ArchitectureDeepTailStageDefinition = {
  ...
  /** Artifact kind label as used by WorkspaceArtifactKind */
...
const implementationTarget: ArchitectureDeepTailStageDefinition = {
  ...
  storageRelativeDir: "architecture/04-materialization/implementation-targets",
  pathPrefix: "architecture/04-implementation-targets/",
  storagePathPrefix: "architecture/04-materialization/implementation-targets/",
...
const implementationResult: ArchitectureDeepTailStageDefinition = {
  ...
  storageRelativeDir: "architecture/04-materialization/implementation-results",
  pathPrefix: "architecture/05-implementation-results/",
  storagePathPrefix: "architecture/04-materialization/implementation-results/",
...
const retained: ArchitectureDeepTailStageDefinition = {
  ...
  storageRelativeDir: "architecture/04-materialization/retained",
  pathPrefix: "architecture/06-retained/",
  storagePathPrefix: "architecture/04-materialization/retained/",
...
const integrationRecord: ArchitectureDeepTailStageDefinition = {
  ...
  storageRelativeDir: "architecture/04-materialization/integration-records",
  pathPrefix: "architecture/07-integration-records/",
  storagePathPrefix: "architecture/04-materialization/integration-records/",
...
const consumptionRecord: ArchitectureDeepTailStageDefinition = {
  ...
  storageRelativeDir: "architecture/04-materialization/consumption-records",
  pathPrefix: "architecture/08-consumption-records/",
  storagePathPrefix: "architecture/04-materialization/consumption-records/",
...
const postConsumptionEvaluation: ArchitectureDeepTailStageDefinition = {
  ...
  storageRelativeDir: "architecture/04-materialization/post-consumption-evaluations",
  pathPrefix: "architecture/09-post-consumption-evaluations/",
  storagePathPrefix: "architecture/04-materialization/post-consumption-evaluations/",
