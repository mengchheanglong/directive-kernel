...
export type ArchitectureRetentionConfirmResult = {
  ok: true;
  created: boolean;
  snapshotAt: string;
  directiveRoot: string;
...
export type ArchitectureRetentionDetail = {
  directiveRoot: string;
  retainedRelativePath: string;
  retainedAbsolutePath: string;
  resultRelativePath: string;
...
function resolveRetentionReviewResolution(
  resultDetail: ReturnType<typeof readArchitectureImplementationResultDetail>,
...
export function confirmDirectiveArchitectureRetention(
...
): ArchitectureRetentionConfirmResult {
  ...
  const resultDetail = readArchitectureImplementationResultDetail({
    directiveRoot,
...
export function readArchitectureRetentionDetail(input: {
  retainedPath: string;
  directiveRoot?: string;
}): ArchitectureRetentionDetail {
