...
export type ArchitectureConsumptionRecordResult = {
  ok: true;
  created: boolean;
  snapshotAt: string;
  directiveRoot: string;
...
export type ArchitectureConsumptionRecordDetail = {
  directiveRoot: string;
  consumptionRelativePath: string;
  consumptionAbsolutePath: string;
  integrationRelativePath: string;
...
export function recordDirectiveArchitectureConsumption(
...
): ArchitectureConsumptionRecordResult {
  ...
  const integrationDetail = readArchitectureIntegrationRecordDetail({
    directiveRoot,
...
export function readArchitectureConsumptionRecordDetail(input: {
  consumptionPath: string;
  directiveRoot?: string;
}): ArchitectureConsumptionRecordDetail {
