...
export type ArchitectureImplementationTargetResult = {
  ok: true;
  created: boolean;
  snapshotAt: string;
  directiveRoot: string;
...
export type ArchitectureImplementationTargetDetail = {
  directiveRoot: string;
  targetRelativePath: string;
  targetAbsolutePath: string;
  adoptionRelativePath: string;
...
function resolveLegacyImplementationTargetContext(input: {
  adoptionDetail: ReturnType<typeof readArchitectureAdoptionDetail>;
  artifactType: ArchitectureArtifactType;
  artifactPath: string;
...
function resolveImplementationTargetSourceContext(input: {
  ...
  if (input.adoptionDetail.sourceResultRelativePath) {
    const sourceResult = readArchitectureBoundedResultArtifact({
...
export function createDirectiveArchitectureImplementationTarget(
...
): ArchitectureImplementationTargetResult {
  ...
  const adoptionDetail = readArchitectureAdoptionDetail({
    directiveRoot,
...
export function readArchitectureImplementationTargetDetail(input: {
  targetPath: string;
  directiveRoot?: string;
}): ArchitectureImplementationTargetDetail {
