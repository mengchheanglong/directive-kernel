...
export type ArchitectureIntegrationRecordCreateResult = {
  ok: true;
  created: boolean;
  snapshotAt: string;
  directiveRoot: string;
...
export type ArchitectureIntegrationRecordDetail = {
  directiveRoot: string;
  integrationRelativePath: string;
  integrationAbsolutePath: string;
  retainedRelativePath: string;
...
export function createDirectiveArchitectureIntegrationRecord(
...
): ArchitectureIntegrationRecordCreateResult {
  ...
  const retainedDetail = readArchitectureRetentionDetail({
    directiveRoot,
...
export function readArchitectureIntegrationRecordDetail(input: {
  integrationPath: string;
  directiveRoot?: string;
}): ArchitectureIntegrationRecordDetail {
