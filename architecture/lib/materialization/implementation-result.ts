...
export type ArchitectureImplementationResultCreateResult = {
  ok: true;
  created: boolean;
  snapshotAt: string;
  directiveRoot: string;
...
export type ArchitectureImplementationResultDetail = {
  directiveRoot: string;
  resultRelativePath: string;
  resultAbsolutePath: string;
  targetRelativePath: string;
...
): ArchitectureImplementationResultCreateResult {
...
export function readArchitectureImplementationResultDetail(input: {
  resultPath: string;
  directiveRoot?: string;
}): ArchitectureImplementationResultDetail {
