...
export type ArchitecturePostConsumptionEvaluationResult = {
  ok: true;
  created: boolean;
  snapshotAt: string;
  directiveRoot: string;
...
export type ArchitecturePostConsumptionEvaluationDetail = {
  directiveRoot: string;
  evaluationRelativePath: string;
  evaluationAbsolutePath: string;
  consumptionRelativePath: string;
...
export function evaluateDirectiveArchitectureConsumption(
...
): ArchitecturePostConsumptionEvaluationResult {
  ...
  const consumptionDetail = readArchitectureConsumptionRecordDetail({
    directiveRoot,
...
export function readArchitecturePostConsumptionEvaluationDetail(input: {
  evaluationPath: string;
  directiveRoot?: string;
}): ArchitecturePostConsumptionEvaluationDetail {
