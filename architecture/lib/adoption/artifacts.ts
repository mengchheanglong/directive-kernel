...
export type ArchitectureSelfImprovementArtifact = {
...
export type ArchitectureAdoptionDecisionArtifact = {
...
export type ArchitectureAdoptionDecisionArtifactInput =
  ArchitectureAdoptionInput & {
    ...
    selfImprovement?: ArchitectureSelfImprovementArtifact;
...
function buildRuntimeHandoff(
  input: ArchitectureAdoptionDecisionArtifactInput,
  resolution: ArchitectureAdoptionResolution,
) {
...
export function buildDirectiveArchitectureAdoptionDecisionArtifact(
  ...
  return mergeDirectiveArtifactSections({
    ...
    decision,
  }) as ArchitectureAdoptionDecisionArtifact;
}

export function isDirectiveArchitectureAdoptionDecisionArtifact(
  value: unknown,
): value is ArchitectureAdoptionDecisionArtifact {
