...
export type ArchitectureDecisionVerdict =
  ArchitectureAdoptionDecisionArtifact["decision"]["verdict"];

export type ArchitectureCycleDecisionSummary = {
...
export function summarizeDirectiveArchitectureCycleDecisions(input: {
  adoptionArtifacts: ArchitectureAdoptionDecisionArtifact[];
