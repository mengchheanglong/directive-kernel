...
export type ArchitectureReviewTransitionRequest = {
  from: "evaluated";
  to: ReviewFeedbackPlan["recommendedNextState"];
  role: ReviewFeedbackPlan["requiredRole"];
};
...
export type ArchitectureReviewResolution = {
  ...
  lifecycleFeedback: ReviewFeedbackPlan;
